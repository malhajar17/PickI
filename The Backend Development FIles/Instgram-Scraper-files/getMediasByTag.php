...
$instagram = \InstagramScraper\Instagram::withCredentials('malhajar17', 'Mohamed11', '/Users/mohamedalhajar/Downloads/instagram-scraper-master3');
//moisopol
//Mohamed11
...
foreach ($HashtagsArray as $keydir => $value) {
	...
	$response=array();
	$db = new DbOperation();
	$medias = $instagram->getMediasByTag($value, 4);
...
// var_dump($medias);
	foreach ($medias as $key => $media) {
		...
		// } catch (Exception $e) {
			...
			// continue;
		// }
		if ($media->getLikesCount()< 10000) {
			echo "less that 10000";
			continue;
		}
		// var_dump(expression)
